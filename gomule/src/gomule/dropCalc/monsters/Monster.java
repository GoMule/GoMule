...
//	}
	...
	public void lookupBASETCReturnATOMICTCS(int nPlayers, int nGroupSize, double input) {

		for(int t = 0;t<mTuples.size();t=t+1){


			
		((MonsterTuple)mTuples.get(t)).lookupBASETCReturnATOMICTCS(nPlayers, nGroupSize, input);
